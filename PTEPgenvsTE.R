...
library(rtracklayer)
#import BED file for genome assemblies and start/end locations
...
library(Gviz)
library(BSgenome)
#i created a package for Ptep V2 to be used by BSgenome visualizations, will include in documentation on github
...
#create track for Ptep.v2 genome, shows nucleotides when zoomed in and gives relative position for TEs
